...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Amber glow */}
      <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-amber-500/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-300 text-xl leading-relaxed mb-10 max-w-lg">
              500+ vehicles. 12 pickup locations. Zero hidden fees.
              From the airport to the CBD — we&apos;ve got you covered.
            </p>
