    ...
    <footer id="contact" className="bg-slate-950 text-slate-400">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+61396001234" className="hover:text-green-400 transition-colors">
                  (03) 9600 1234
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-green-500 shrink-0" />
                <a href="mailto:hello@glidego.com.au" className="hover:text-green-400 transition-colors">
                  hello@glidego.com.au
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs">
          <p>© {new Date().getFullYear()} GlideGo Car Rentals Pty Ltd. All rights reserved. ABN 12 345 678 901</p>
          <div className="flex gap-5">
            {["Privacy Policy", "Terms of Use", "Cookie Policy"].map((t) => (
              <a key={t} href="#" className="hover:text-green-400 transition-colors">{t}</a>
            ))}
          </div>
        </div>
      </div>
